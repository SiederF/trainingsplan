...
const ASSETS = [
  ...
  './js/core/timer.js', './js/core/crypto.js', './js/core/sync.js', './js/core/secrets.js', './js/core/readiness.js', './js/core/metrics.js', './js/core/rehab.js', './js/core/notify.js', './js/core/climbing.js', './js/core/wakelock.js', './js/core/sound.js', './js/core/workout.js',
  './js/ui/dom.js', './js/ui/planView.js', './js/ui/runnerView.js',
  './js/ui/timerOverlay.js', './js/ui/syncView.js', './js/ui/readinessView.js', './js/ui/climbLogView.js', './js/ui/progressView.js',
